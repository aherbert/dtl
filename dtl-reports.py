#!/usr/bin/env python3
"""Program to create reports on the DtL analysis results."""
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="""Program to create reports on the DtL analysis results.""",
...
""",
    ...
    from dtl.reports import create_report, load_data, number_of_reports
